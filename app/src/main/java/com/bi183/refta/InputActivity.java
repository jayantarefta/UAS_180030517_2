...
import com.bi183.refta.model.ResponseData;
import com.bi183.refta.services.ApiClient;
import com.bi183.refta.services.ApiContact;
...
public class InputActivity extends AppCompatActivity {
        ...
        switch(view.getId()) {
            case R.id.jekel_laki:
                if (checked) {
                    ...
                    imgLocation = ApiClient.IMAGE_URL + "ada.png";
                    break;
                }
            case R.id.jekel_perempuan:
                if (checked) {
                    gender = getString(R.string.gender_female);
                    imgLocation = ApiClient.IMAGE_URL + "kosong.png";
                    break;
                }
        }
    }
    ...
    private void saveData() {
        ...
        if(!(firstName.equals("") && lastName.equals("") && number.equals(""))) {
            ...
            Toast.makeText(this, "Data nama dan harga barang harus diberikan", Toast.LENGTH_LONG).show();
        }
